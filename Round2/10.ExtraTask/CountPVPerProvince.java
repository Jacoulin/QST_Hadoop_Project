 ...
 */
public class CountPVPerProvince {
    public static class DefMap extends Mapper<LongWritable, Text, Text, LongWritable> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String strProvince = line[3];
            province.set(strProvince);
            count.set(1);
    ...
    public static class DefReduce extends TableReducer<Text, LongWritable, ImmutableBytesWritable> {
        ...
        protected void reduce(Text key, Iterable<LongWritable> values, Context context) throws IOException, InterruptedException {
            ...
            put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("pv"), String.valueOf(count).getBytes());
            context.write(new ImmutableBytesWritable(key.toString().getBytes()), put);
        }
    }

    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        String tableName = "province_pv";
        ...
        Job job = Job.getInstance(conf, "CountPVPerProvince");

        job.setJarByClass(CountPVPerProvince.class);
